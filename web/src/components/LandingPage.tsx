    ...
    <div className="landing-page">
      ...
      <section className="hero-section">
        ...
        <div className="container">
          ...
          >
            <motion.div className="hero-badge" variants={fadeInUp} transition={{ duration: 0.8 }}>
              <Leaf className="hero-icon" />
              <span>100% Bio & Végétarien</span>
            </motion.div>
            
            <motion.h1 className="hero-title" variants={fadeInUp} transition={{ duration: 0.8 }}>
              Découvrez l'excellence
              <span className="highlight"> végétale</span>
            </motion.h1>
            
            <motion.p className="hero-subtitle" variants={fadeInUp} transition={{ duration: 0.8 }}>
