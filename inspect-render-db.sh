...
echo "🔍 INSPECTION DE LA BASE DE DONNÉES POSTGRESQL PRODUCTION (RENDER)"
echo "=================================================================="
echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo "💡 Vérifiez que PostgreSQL est installé et que la connexion est disponible"
    exit 1
fi
...
LIMIT 10;" "Migrations Flyway (10 dernières)"
